...
net_file = './deploy_transplant.prototxt'
...
def postprocess(out, img_h, img_w):
    ...
    output = []
    output.append(out['conv11_mbox_conf_perm'].reshape((-1)))
    output.append(out['conv11_mbox_loc_perm'].reshape((-1)))
    output.append(out['conv13_mbox_conf_perm'].reshape((-1)))
    output.append(out['conv13_mbox_loc_perm'].reshape((-1)))
    output.append(out['conv14_2_mbox_conf_perm'].reshape((-1)))
    output.append(out['conv14_2_mbox_loc_perm'].reshape((-1)))
    output.append(out['conv15_2_mbox_conf_perm'].reshape((-1)))
    output.append(out['conv15_2_mbox_loc_perm'].reshape((-1)))
    output.append(out['conv16_2_mbox_conf_perm'].reshape((-1)))
    output.append(out['conv16_2_mbox_loc_perm'].reshape((-1)))
    output.append(out['conv17_2_mbox_conf_perm'].reshape((-1)))
    output.append(out['conv17_2_mbox_loc_perm'].reshape((-1)))
...
def detect(imgfile):
    ...
    for i in range(len(predbox)):
        ...
        cv2.putText(origimg, title, ptext, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2, cv2.LINE_AA)
