...
net_file = './deploy_transplant_NoPermute.prototxt'
...
def postprocess(out, img_h, img_w):
    ...
    output = []
    output.append(out['conv11_mbox_conf'].reshape((-1)))
    output.append(out['conv11_mbox_loc'].reshape((-1)))
    output.append(out['conv13_mbox_conf'].reshape((-1)))
    output.append(out['conv13_mbox_loc'].reshape((-1)))
    output.append(out['conv14_2_mbox_conf'].reshape((-1)))
    output.append(out['conv14_2_mbox_loc'].reshape((-1)))
    output.append(out['conv15_2_mbox_conf'].reshape((-1)))
    output.append(out['conv15_2_mbox_loc'].reshape((-1)))
    output.append(out['conv16_2_mbox_conf'].reshape((-1)))
    output.append(out['conv16_2_mbox_loc'].reshape((-1)))
    output.append(out['conv17_2_mbox_conf'].reshape((-1)))
    output.append(out['conv17_2_mbox_loc'].reshape((-1)))
